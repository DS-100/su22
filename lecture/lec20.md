...
- [recording](https://bcourses.berkeley.edu/courses/1515881/external_tools/78985){:target="_blank"} (Note: the recording has two parts. I forgot to record the first 15 minutes during live so Part 1 is a re-record.)
